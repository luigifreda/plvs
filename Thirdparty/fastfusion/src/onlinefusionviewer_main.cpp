...
int main(int argc, char *argv[])
{
    ...
    {
        std::cout << "ERROR - reading default file name for associations  ****** " << std::endl;
    ...
    for (unsigned int i = 0; i < associationfilenames.size(); i++)
    {
        ...
        std::cout << "\nprefices[" << i << "]: " << prefices[i] << std::endl; 
    }
    ...
    if (!useLoopClosures)
    {
        ...
        {
            std::cout << "reading association file: " << associationfilenames[f] << std::endl; 
            ...
            else
            {
                ...
                while (!associationfile.eof())
                {
                    ...
                    stream >> junkstamp;
                    stream >> depthname;
                    //std::cout  << "depthname: " << depthname << std::endl; 
                    if (temp != "")
                    {
                        ...
                        //std::cout  << "rgbname: " << rgbname << std::endl; 
                    }
                }
