...
public:
    ...
    typedef struct MeshStatistic_
    {
        ...
        : frameNumber(frameNumber_p), queueSize(queueSize_p), arraySize(arraySize_p), timeUpdate(timeUpdate_p), timeSum(timeSum_p)
        {
        }
    } MeshStatistic;
