...
typedef Eigen::Matrix<FloatingPoint, 3, 1> Normal;
...
typedef AlignedVector<Normal> Normals;
...
typedef kindr::minimal::QuatTransformationTemplate<FloatingPoint>::TransformationMatrix TransformationMatrix44;

typedef Eigen::Transform<FloatingPoint, 3, Eigen::Affine> AffineTransform;
typedef Eigen::Transform<FloatingPoint, 3, Eigen::Isometry> IsometryTransform;
