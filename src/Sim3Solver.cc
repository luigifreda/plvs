...
// a first step could be using lines for inliers checking 
    ...
    mnIterations(0), mnBestInliers(0), mbFixScale(bFixScale)
{
    ...
    for(int i1=0; i1<mN1; i1++)
    {
        if(vpMatched12[i1])
        {
            ...
            mvnMaxError1.push_back(9.210*sigmaSquare1); // 9.21  -> chi_square with alpha=0.99  and n=2 (see HZ pag 567)
