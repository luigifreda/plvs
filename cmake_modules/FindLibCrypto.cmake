...
if (crypto_FOUND)
    ...
    if (NOT LIBCRYPTO_FOUND)
        if (LIBCRYPTO_FIND_REQUIRED)
            message(STATUS "Found libcrypto include dir: ${LibCrypto_INCLUDE_DIR}")
            message(STATUS "Found libcrypto libs : ${LibCrypto_LIBRARY}")
            message(FATAL_ERROR "-- Could not find libcrypto")
        endif (LIBCRYPTO_FIND_REQUIRED)
    endif()
endif()