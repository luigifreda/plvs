...
$DEBUG_PREFIX ../Examples$SUFFIX/Stereo-Inertial/stereo_inertial_euroc$SUFFIX \
    ../Vocabulary/ORBvoc.txt \
    ../Examples$SUFFIX/Stereo-Inertial/$EUROC_YAML \
    $PATH_TO_SEQUENCE_FOLDER \
    ../Examples$SUFFIX/Stereo-Inertial/EuRoC_TimeStamps/$SEQUENCE'.txt' \
    $OUTPUT_BASE_NAME
