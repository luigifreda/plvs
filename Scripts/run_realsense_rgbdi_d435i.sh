...
$DEBUG_PREFIX ../Examples$SUFFIX/RGB-D-Inertial/rgbd_inertial_realsense_D435i$SUFFIX ../Vocabulary/ORBvoc.bin ../Examples$SUFFIX/RGB-D-Inertial/RealSense_D435i_calib.yaml
