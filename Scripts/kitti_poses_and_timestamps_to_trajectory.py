...
# from https://github.com/MichaelGrupp/evo/blob/master/contrib/kitti_poses_and_timestamps_to_trajectory.py
...
def kitti_poses_and_timestamps_to_tum_trajectory(poses_file, timestamp_file):
...
if __name__ == "__main__":
    ...
    trajectory = kitti_poses_and_timestamps_to_tum_trajectory(args.poses_file, args.timestamp_file)
